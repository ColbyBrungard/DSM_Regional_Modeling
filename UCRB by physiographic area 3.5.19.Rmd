...
#Need to rerun for mistake in code, then uncomment above chunk and delete this chunk
 for (i in 1:4) {
 raster::predict(object=Mpred1, model=c.eco3[5:8][i], index = 1:6, type = 'prob', progress="text", filename = paste0('Z:/UCRB/Predictions/phy_area/', 'eco3', names(c.eco3)[i], '_prob','.tif'), datatype = 'FLT4S', options=c("COMPRESS=LZW"))
 }
...
Time to run = 
(59025+61179+56601+59259+44684+46612+41673+43784+57100+54903+56536+57084+56608+42200+40377+41914+42004+41076+46439+43450+40921+45464+40996+40982+42082+42749+61042+56524+56743+57504+58391+50505+65186)/3600
~ 460 hours or about 19 days. 32 GB RAM, using 31 processors. 
